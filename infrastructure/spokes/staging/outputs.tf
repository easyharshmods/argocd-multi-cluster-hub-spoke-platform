output "cluster_name" {
  description = "Staging spoke EKS cluster name"
  value       = module.eks.cluster_name
}

output "cluster_endpoint" {
  description = "Staging spoke EKS cluster endpoint"
  value       = module.eks.cluster_endpoint
}

output "cluster_certificate_authority_data" {
  description = "Staging spoke EKS cluster CA data"
  value       = module.eks.cluster_certificate_authority_data
}

output "vpc_id" {
  description = "Staging spoke VPC ID"
